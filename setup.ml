...
(* OASIS_START *)
(* DO NOT EDIT (digest: f17bf339c4672c2ac93df4ccc8e25c97) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test1.native", []))];
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "print nested boxes, tables, etc.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the HTML rendering library";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["PrintBox"; "PrintBox_text"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "printbox";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "prinbox_html";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["PrintBox_html"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "printbox";
                      lib_findlib_name = Some "html";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Printbox Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "docs",
                                OASISExpr.EAnd
                                  (OASISExpr.EFlag "docs",
                                    OASISExpr.EFlag "html")),
                             true)
                        ];
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Printbox_html Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\023\132\212\222\153\193\017\206\027+O\228X\203\129.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
